...
public class DummyCommandHandler extends AbstractMessageHandler implements ICommandHandler {
    ...
    public DummyCommandHandler(String outboundEndpoint, IMessageBusFactory messageBusFactory, IRepositoryFactory repositoryFactory) {
